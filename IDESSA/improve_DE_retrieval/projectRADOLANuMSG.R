...
library(Rainfall)
library(rgdal)
msgpath="/media/memory01/casestudies/hmeyer/Improve_DE_retrieval/MSG/2010/"
radarpath="/media/memory01/casestudies/hmeyer/Improve_DE_retrieval/Radar_R_Grid/"
...
template_rw<-raster("/media/memory01/casestudies/hmeyer/Improve_DE_retrieval/templates/raa01-rw_10000-1005312050.tif")
template_msg<-raster("/media/memory01/casestudies/hmeyer/Improve_DE_retrieval/templates/201010101150_mt09s_B0103xxxx_m1hct_1000_rg01de_003000.rst")
