...
for (traintest in c("train","test")){
  ...
  save(dataset,file=paste0(outpath,traintest,"_dataset.RData"))
  ...
  save(dataset,file=paste0(outpath,traintest,"_dataset.RData"))
  save(dataset_day,file=paste0(outpath,traintest,"_dataset_day.RData"))
  save(dataset_night,file=paste0(outpath,traintest,"_dataset_night.RData"))
}