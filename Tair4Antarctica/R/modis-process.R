...
lap = "../../data/MODIS_ARC"
MODISoptions(lap, file.path(lap, "PROCESSED"), outProj = "+init=epsg:4326"
...
# swb = runGdal("MOD09GA", extent = antarctica, collection = "006"
#               , begin = "2000.02.24", end = "2000.02.24"
#               , SDSstring = "0100000000011111111000", job = "mod09ga-antarctica")
# 
