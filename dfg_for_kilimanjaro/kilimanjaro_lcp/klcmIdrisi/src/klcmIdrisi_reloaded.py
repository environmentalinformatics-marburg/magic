...
def get_aster_datasets(input_aster_path):
    ...
    elif "ast14dmo_00302282011075438_20111206102625_30591" in input_aster_path:
        ast_code = "AST_20110228_"
    elif "ast14dmo_00311022008075503_20130307023703_15002" in input_aster_path:
        ast_code = "AST_20081102_"
    elif "ast14dmo_00302112005075416_20130307023702_14997" in input_aster_path:
...
def main():
    ...
    python klcmIdrisi_reloaded.py -i E:\kilimanjaro_landcover\satellite_data\osm_mrg_utm37s -o E:\kilimanjaro_landcover\plots -a E:\kilimanjaro_landcover\satellite_data\ast14dmo_00302282011075438_20111206102625_30591\bands -d E:\kilimanjaro_landcover\satellite_data\dem -g E:\kilimanjaro_landcover\idrisi
    
    python klcmIdrisi_reloaded.py -i E:\kilimanjaro_landcover\satellite_data\osm_mrg_utm37s -o E:\kilimanjaro_landcover\plots -a E:\kilimanjaro_landcover\satellite_data\ast14dmo_00311022008075503_20130307023703_15002\bands -d E:\kilimanjaro_landcover\satellite_data\dem -g E:\kilimanjaro_landcover\idrisi
    
    python klcmIdrisi_reloaded.py -i E:\kilimanjaro_landcover\satellite_data\osm_mrg_utm37s -o E:\kilimanjaro_landcover\plots -a E:\kilimanjaro_landcover\satellite_data\ast14dmo_00302112005075416_20130307023702_14997\bands -d E:\kilimanjaro_landcover\satellite_data\dem -g E:\kilimanjaro_landcover\idrisi
    
    python klcmIdrisi_reloaded.py -i E:\kilimanjaro_landcover\satellite_data\osm_mrg_utm37s -o E:\kilimanjaro_landcover\plots -a E:\kilimanjaro_landcover\satellite_data\ast14dmo_composite\bands -d E:\kilimanjaro_landcover\satellite_data\dem -g E:\kilimanjaro_landcover\idrisi
    ...
    for target_plot in target_plots:
        ...
        for entry in ast_output_dict:
            ...
            "AST_MNF3_SOL" is not entry and "AST_MNF1_SOL_I" is not entry and \
            "AST_MNF2_SOL_I" is not entry and "AST_MNF3_SOL_I" is not entry and \
            "RGF" not in entry and "OVERLAY" not in entry and \
            "TEMP" not in entry:
        ...
        misc_output_path = output_filepath_prefix + "misc" + os.sep
        ...
        for file in files:
            if "_S." not in file and "osm_mrg_epsg-32737_123" not in file and \
                "030201" not in file and "SEGTRAIN" not in file and \
                "207010" not in file and ".rgf" not in file:
                try:
        ...
        idrisi_cmd = rgf_mnf_sol_s_filepath + "*" + \
            output_filepath_prefix + ast_code + "MNF_SOL_S_207010_7030" + \
            "*" + "3" + "*" + \
        ...
        for segtrain_filepath in segtrain_files:
            ...
            classification_prefix =  \
                ...
                os.path.basename(segtrain_filepath)[10:18] + "S" + \
            ...
            for segmentation_filepath in segmentation_files:
                if "SEGTRAIN" not in segmentation_filepath:
                    for classification_filepath in classification_files:
                        print "Computing mode patterns for " + \
                            os.path.basename(classification_filepath) + \
                            " using " + \
                            os.path.basename(segmentation_filepath)
                        segmentation_filename = os.path.splitext(\
                            os.path.basename(segmentation_filepath))[0]
                        char_pos = list(find_strings(\
                            segmentation_filename, "_"))[-1]
                        classification_filepath_mode = os.path.splitext(\
                            classification_filepath)[0] + \
                            segmentation_filename [char_pos:]
