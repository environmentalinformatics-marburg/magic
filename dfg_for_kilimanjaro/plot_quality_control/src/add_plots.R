...
input.filepath <- "plot_poles_arc1960_mod/PlotPoles_ARC1960_mod_20140410_v04_add_by_bing.shp"
...
plots.new <- data.frame(PlotID = c("emg0", "mch0", "foc0", "mwh0", "mai0", "sav0", "foc6", "mcg0", "fpo0"),
                        PoleName = "A middle pole",
                        PoleType = "AMP",
                        POINT_X = NaN,
                        POINT_Y = NaN,
                        coords_x3 = 0,
                        coords.x1 = c(335386, 307231, 305477, 318531, 304694, 353957, 304864, 304864, 306464),
                        coords.x2 = c(9641965, 9658017, 9655113, 9651408, 9634264, 9634163, 9652552, 9652552, 9657059))
