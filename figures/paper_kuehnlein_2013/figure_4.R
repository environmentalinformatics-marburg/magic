...
## read data
inpath <- "C:/tappelhans/uni/marburg/colleagues/meike/article/figure_processing/figure_1&2/figure_4"

dat <- read.table(paste(inpath, "mergeCloudMSG_200806041245_mask_tau_gt_00_all.dat",
                         sep = "/"), header=T, na.strings="-99.000000")

dat1 <- read.table(paste(inpath, "mergeCloudMSG_200806041245_mask_tau_gt_00_all_01.dat",
                         sep = "/"), header=T, na.strings="-99.000000")
dat2 <- read.table(paste(inpath, "mergeCloudMSG_200806041245_mask_tau_gt_00_all_02.dat",
                         sep = "/"), header=T, na.strings="-99.000000")
