...
inpath <- "C:/tappelhans/uni/marburg/colleagues/meike/article/figure_processing/figure_11/new"
...
descr <- c("a)  AEF SLALOM MODIS", "b)  AEF MOD06")
...
png(paste(inpath, "figure_11.png", sep = "/"), res = 300, width = 1024*3, 
    height = 768*3)
print(out)
dev.off()