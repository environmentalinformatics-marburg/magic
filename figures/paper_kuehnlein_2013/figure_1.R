...
inpath <- "C:/tappelhans/uni/marburg/colleagues/meike/article/figure_processing/figure_01"
...
descr <- c("a)  COT SLALOM MODIS", "b)  COT MYD06", 
           "c)  COT SLALOM SEVIRI", "d)  VIS BAND 02")
...
## SEE ABOVE
cls <- raster(paste(inpath, "200806111415_CLOUDSAT_TRACK.RST",
                    sep = "/"), native = T, crs = "+proj=latlong")
cls <- crop(cls, ext)
newvals <- values(cls)
