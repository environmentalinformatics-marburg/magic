...
public class Station {
	...
	public Station(TimeSeriesDatabase timeSeriesDatabase, GeneralStation generalStation, String stationID, LoggerType loggerType, List<StationProperties> propertyMapList, boolean isPlot) {
		this.isPlot = isPlot;
